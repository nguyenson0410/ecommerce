  ...
  const handlerSignUp = (e) => {
    ...
    const conditionObj = {
      fullname: () => {
        ...
        return !fullname ? true : setFullnameError(false);
      },
      email: () => {
        setEmailError(true);
        return !email ? true : setEmailError(false);
      },
      validateEmail: () => {
        setEmailRegex(true);
      ...
      password: () => {
        ...
        return !password ? true : setPasswordError(false);
      },
      phone: () => {
        setPhoneError(true);
        return !phone ? true : setPhoneError(false);
      },
    };
    for (let key in conditionObj) {
      console.log(conditionObj[key], conditionObj[key]());
      if (conditionObj[key]()) break;
...
*/
  ...
  // signup thanh cong redirect va sign in
  if (success) {
