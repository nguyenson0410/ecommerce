            ...
            {listCart &&
              listCart.map((value) => (
                <tr className="text-center" key={value._id}>
                  ...
                  <td className="align-middle border-0">
                    <p className="mb-0 small">{value.user_id._id}</p>
                  </td>
                  <td className="align-middle border-0">
                    <p className="mb-0 small">{value.user_id.fullname}</p>
                  </td>
                  <td className="align-middle border-0">
                    <p className="mb-0 small">{value.user_id.phone_number}</p>
                  </td>
                  <td className="align-middle border-0">
                    <p className="mb-0 small">{value.user_id.address}</p>
                  </td>
                  <td className="align-middle border-0">
                  ...
                  <td className="align-middle border-0">
                    <p className="mb-0 small">
                      {value.delivery === "Chưa Vận Chuyển"
                        ? "Chưa Vận Chuyển"
                        : "Đã Vận Chuyển"}
                    </p>
                  </td>
